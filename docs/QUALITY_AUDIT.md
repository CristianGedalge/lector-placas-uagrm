...
| Q-08 | Cobertura desigual en API y tareas de medios. | P2 | Cobertura total 63%; `access_logs` 20%, `media_tasks` 22%, `vehicles` 22%. | Regresiones de autorización/transacción no detectadas. | Añadir pruebas de integración con PostgreSQL/Cloudinary simulados. | Mayor tiempo de CI y mantenimiento de fixtures. |
